...
select *
from encounter
where extract(year from earliest_visit_date_time) = 2021
  and extract(year from created_date_time) = 2022 and encounter_date_time isnull and cancel_date_time isnull
set role jss;
update encounter
